This repository contains the datasets for the study on virus-drug association prediction using ILRLSVDA methods. The project leverages three datasets to train and evaluate the proposed model.
